# Contributing to OrionLedger

Thanks for taking the time to look at this. API key lifecycle for .NET: issue prefixed high-entropy keys, store only their hash, verify presented keys against scope, expiry, and revocation, and track last use. The project is small and the bar for contributions is "does it make the package clearer, faster, or safer without expanding the public surface needlessly."
...
```bash
git clone https://github.com/tunahanaliozturk/OrionLedger
cd OrionLedger
dotnet restore
